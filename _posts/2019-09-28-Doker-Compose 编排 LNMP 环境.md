---
layout: mypost
title: Doker-Compose 编排 LNMP 环境
categories: [DOCKER,LNMP]
---

[DNMP](https://github.com/teg1c/docker-lnmp)（Docker + Nginx + MySQL + PHP7/5 + Redis）是一款全功能的**LNMP一键安装程序**。
...
![Demo Image](/static/img/dnmp.png)
